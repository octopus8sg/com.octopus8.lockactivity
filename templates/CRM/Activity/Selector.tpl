...
<div class="crm-activity-selector-{$context}">
  ...
  <table class="contact-activity-selector-{$context} crm-ajax-table" style="width: 100%;">
    ...
    <tr>
      ...
      <th data-data="status_id" cell-class="crmf-status_id" cell-data-type="select" cell-data-refresh="true" class="crm-contact-activity-activity_status">{ts}Status{/ts}</th>
